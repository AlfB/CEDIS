...
var onPointerMove = function(evt) {
    ...
    map.forEachFeatureAtPixel(pixel, function(feature, layer) {
        ...
        if (feature, layer) {
          info.innerHTML = 'Clave Municipio: ' + feature.getId() + ' Municipio: ' + feature.get('NOM_MUN') + ', Población Total: ' + feature.get('POBTOT') + 
		  ', Región: ' + feature.get('REGION_NOM') + '-' + feature.get('REGION_DES') + 'Clave Localidad: ' + feature.get('CVE_LOC');
        } else {
          info.innerHTML = '&nbsp;';
        }
		/* var info = document.getElementById('info_2');
        if (feature, layer) {
          info.innerHTML = 'Clave Municipio: ' + feature.getId() + ' Municipio: ' + feature.get('NOM_MUN') + ', Población Total: ' + feature.get('POBTOT') + 
		  ', Región: ' + feature.get('REGION_NOM') + '-' + feature.get('REGION_DES');
        } else {
          info.innerHTML = '&nbsp;';
        }*/
